...
@InveTest
Scenario: TC-01 WAR-83 Create Inventory
...
Then the response body for Inventory should contain key "type" with value "success"
 ...
 Scenario: TC-02 War-80 Get Master Data All
...
Then the response body for Inventory should contain key "type" with value "success"
 ...
 Scenario: TC-06 War-89  fetch Suppliers for a given itemNumber
...
Then the response body for Inventory should contain key "type" with value "success"
 ...
 Scenario: TC-10 WAR-240 Create customer inventory price
...
Then the response body for Inventory should contain key "type" with value "success"
 ...
 Scenario: TC-11 WAR-260 fetch special prices for a given customer or item number
...
Then the response body for Inventory should contain key "type" with value "success"
 ...
 Scenario: TC-12 WAR-269 fetch adjustment history for a given inventory
...
Then the response body for Inventory should contain key "type" with value "success"
 ...
 Scenario: TC-13 war-263 create qtyAdjustment
Given I send a Post request for Inventory from "war-263 create qtyAdjustment.json" and capture the response body
When The order request response for Inventory from has a '201' response code
Then the response body for Inventory should contain key "type" with value "success"
@InveTest
Scenario: TC-14 WAR-84 Delete inventory
Given I send a Delete request for Inventory from "WAR-84 Delete inventory" and capture the response body
When The order request response for Inventory from has a '204' response code

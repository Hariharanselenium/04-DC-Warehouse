...
Scenario: TC-20 WAR 162 update invoice
...
Scenario: TC-23 WAR 234 Accept the payments anywhere
...
Scenario: TC-24 WAR 292 create special price for customer
